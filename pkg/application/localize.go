...
import (
	...
	"easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/localize/localize"
	"easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/translations"
	filetranslation "easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/translations/providers/file_translation"
	"easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/translations/providers/tolgee"
