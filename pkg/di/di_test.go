...
import (
	...
	clickdb "easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/mock/db/click/db"
	pgdb "easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/mock/db/pg/db"
	usrv "easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/mock/services/userservice"
