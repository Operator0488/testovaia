...
Настройки подключения к Postgres описаны в конфигурационном файле [в документе](../config/doc.md)
...
1) Установить `atlas`
2) Настроить конфиг файл `atlas.hcl` (есть в репозитории темплейта https://easybnk.gitlab.yandexcloud.net/backend/service-template)
