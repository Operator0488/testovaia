...
import (
	...
	"easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/localize/parser"
	"easybnk.gitlab.yandexcloud.net/backend/platform-core/internal/pkg/localize/plural"
