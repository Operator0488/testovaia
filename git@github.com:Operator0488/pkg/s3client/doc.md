...
Клиент реализован в виде пакета https://easybnk.gitlab.yandexcloud.net/backend/platform-core/s3client, в качестве базового пакета использован https://github.com/minio/minio-go.
